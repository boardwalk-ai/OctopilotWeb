              ...
              >
                ...
                <div
                  className={`
                    ...
                    ${isExpanded || isSelected ? "scale-150" : ""}
                  `}
                >
                  <Icon size={16} />
                </div>
                ...
                <div
                  className={`
                    ...
                    ${isExpanded || isSelected ? "text-white scale-125" : "text-white/70"}
                  `}
                  style={{ left: "50%", transform: isExpanded || isSelected ? "translateX(-50%) scale(1.25)" : "translateX(-50%)" }}
                >
                  {item.title}
                </div>
