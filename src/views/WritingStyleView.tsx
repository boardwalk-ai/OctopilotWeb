...
export default function WritingStyleView({ onBack, onNext }: WritingStyleViewProps) {
    return (
        <div className="flex flex-1 flex-col items-center px-6 pt-36">
            ...
            {/* Upload Box */}
            <div className="flex w-full max-w-[960px] flex-col items-center justify-center rounded-[24px] border border-white/[0.04] bg-white/[0.02] py-20 transition-colors hover:bg-white/[0.03]">
            ...
            <button className="mt-8 flex w-full max-w-[960px] items-center justify-center gap-2.5 rounded-full bg-red-500 px-8 py-3.5 text-[14px] font-semibold text-white shadow-[0_0_24px_rgba(239,68,68,0.3)] transition-all duration-200 hover:bg-red-400 hover:shadow-[0_0_32px_rgba(239,68,68,0.4)]">
                Let us learn
