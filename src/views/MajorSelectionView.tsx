        ...
        <div className="flex w-full flex-1 flex-col px-6 pt-32 pb-0 lg:px-10 2xl:px-14">
            ...
            <div className="flex items-center justify-between gap-4 py-5">
                ...
                <button
                    ...
                    className={`flex min-w-[250px] max-w-[440px] items-center justify-center gap-2 rounded-full px-9 py-3.5 text-[14px] font-semibold transition-all duration-200 ${selected !== null
