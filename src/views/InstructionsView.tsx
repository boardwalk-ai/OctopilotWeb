...
export default function InstructionsView({ onBack, onNext }: InstructionsViewProps) {
    ...
    return (
        <div className="mx-auto flex min-h-full w-full max-w-[1200px] flex-col px-10 pt-32 pb-[100px]">
            ...
            <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-white/[0.06] bg-[#0a0a0a]/95 px-5 backdrop-blur-md">
                <div className="mx-auto flex w-full max-w-[1200px] items-center gap-3 py-5">
                    <button
                        onClick={onBack}
                    ...
                    <button
                        ...
                        className={`group relative flex flex-1 items-center justify-center gap-2 overflow-hidden rounded-full py-3 text-[14px] font-semibold transition-all duration-300 ${isAnalyzing || (!instructions.trim() && !uploadedFile)
