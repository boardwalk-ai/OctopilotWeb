            ...
            <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-white/[0.06] bg-[#0a0a0a]/95 px-5 backdrop-blur-md">
                <div className="flex w-full items-center gap-3 py-5">
                    ...
                    <button
                        ...
                        className={`group relative flex w-full max-w-[440px] items-center justify-center gap-2 overflow-hidden rounded-full py-3 text-[14px] font-semibold transition-all duration-300 ${isAnalyzing || (!instructions.trim() && !uploadedFile)
