    ...
    return (
        <div className="flex w-full flex-1 flex-col px-6 pt-32 pb-0 lg:px-10 2xl:px-14">
            ...
            <div className="flex items-center gap-3 py-5">
                <button
                    onClick={onBack}
                    className="flex flex-1 items-center justify-center gap-2 rounded-full border border-white/[0.1] bg-white/[0.04] py-3 text-[14px] font-semibold text-white/60 transition-all duration-200 hover:border-white/20 hover:bg-white/[0.08] hover:text-white"
                >
