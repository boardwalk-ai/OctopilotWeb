...
- Sources (title, publisher, author, year, compacted content)
...
6. Use EVERY source provided and write the essay based on your knowledge + the sources.
7. Include the keywords: <keyword> (if applicable).
8. Generate the perfectly formatted bibliography for the provided sources based on the <format>.
9. IMPORTANT: Just output the essay and bibliography. No title needed.
10. IMPORTANT: Only write around <word_count>. strictly adhere to the word count, don't write for too much word count gap.
